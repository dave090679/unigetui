...
addon_info = {
	...
	"addon_summary": _("unigetui"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	"addon_description": _("improve accessibility of unigetui, a gui for winget and other package managers"),
	# version
	"addon_version": "0.6",
	# Author(s)
	"addon_author": "David Parduhn <xkill85@gmx.net>",
	# URL for the add-on documentation support
	"addon_url": "http://github.com/dave090679/unigetui/releases",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "http://guthub.com/dave090679/unigetui",
